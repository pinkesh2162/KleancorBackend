...
<div class="page-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="breadcrumb-item active">Create HouseKeeping</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="card tab2-card">
            <div class="card-body">
                <form class="needs-validation" action="{{ route('housekeepings.store') }}" method="POST">
                    @csrf
                        ...
                        <div class="tab-pane fade active show" id="general" role="tabpanel" aria-labelledby="general-tab">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-md-4" for="min_val"><span>*</span>Minimum Value</label>
                                        <div class="col-md-7">
                                            <input class="form-control" type="number" id="min_val" name="min_val" value="{{old('min_val')}}" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-md-4" for="max_val"><span>*</span>Maximum Value</label>
                                        <div class="col-md-7">
                                            <input class="form-control" type="number" id="max_val" name="max_val" value="{{old('max_val')}}" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
