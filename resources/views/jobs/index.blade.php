    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('jobs.create') }}" class="btn btn-primary mt-md-0 mt-2">Create Job</a>
            </div>
                            ...
                            <td>
                                <div>
                                    <form action="{{ route('jobs.destroy',$job->id) }}" method="POST">
                                        <a href="{{ route('jobs.edit', $job->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
