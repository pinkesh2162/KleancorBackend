    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('skills.create') }}" class="btn btn-primary mt-md-0 mt-2">Create Skill</a>
            </div>
                            ...
                            <td>
                                <div>
                                    <form action="{{ route('skills.destroy',$skill->id) }}" method="POST">
                                        <a href="{{ route('skills.edit', $skill->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
