                ...
                <td>
                    ...
                    <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target=""><i
                        class="fa fa-trash-o"></i> Frozen</button>
                                    <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#unfridge-{{ $item->id }}"><i
...
<!--------------------------------------------->
            <!-- Modal -->
            <div id="unfridge-{{ $item->id }}" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="{{ route('activeprojects',$item->id) }}" class="btn btn-danger"><i class="fa fa-trash-o"></i>
                                Active </a>
                            </div>
                    </div>
                </div>
