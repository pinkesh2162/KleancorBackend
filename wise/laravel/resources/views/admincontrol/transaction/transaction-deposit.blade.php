        ...
        <div class="row justify-content-center">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <form method="POST" action="{{ route('transaction.new-deposit-store') }}"
                                ...
                                <table class="table table-responsive table-striped table-hover table-bordered">
                                    ...
                                    @foreach ($transaction as $key => $value)
                                        <tr>
                                            ...
                                            @if (Auth::user()->type == 2)
                                                <td>
                                                    @if ($value->invoice_start && $value->invoice_end)
                                                        <span class="btn btn-warning btn-xs"><i class="fa fa-lock"></i>
                                                            Top Sheet</span>
                                                    @elseif($value->salesid)
                                                        <a href="{{ route('invoice.printPreview', $value->salesid) }}"
                                                            class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>
                                                            Edit</a>
                                                    @else
                                                        <a href="{{ route('transaction.edit-deposit', $value->id) }}"
                                                            class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>
                                                            Edit</a>
                                                        <a href="{{ route('transaction.delete-deposit', $value->id) }}"
