        ...
        <div class="row justify-content-center">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('transaction.employee-debit-update') }}"
                        ...
                        @foreach ($selected as $select)
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="bg-white">
                                        <h4>Edit Employee Expenses</h4>
                                        <hr />
                                        <label>Employee Name</label>
                                        <select class="form-control" name="employee_id">
                                            @foreach ($employee as $emp)
                                                @if ($select->employee_id == $emp->id)
                                                    <option selected value="{{ $emp->id }}">{{ $emp->name }}
                                                    </option>
                                                @else
