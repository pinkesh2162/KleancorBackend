        ...
        <div class="row justify-content-center">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <form method="POST" action="{{ route('transaction.new-expense-store') }}"
                                            ...
                                            @if (Auth::user()->type == 2)
                                                <td>
                                                    @if ($value->salesid)
                                                        {{ 'Invoice Payment' }}
                                                    @else
                                                        <a href="{{ route('transaction.edit-expense', $value->id) }}"
                                                            class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>
                                                            Edit</a>
                                                        <a href="{{ route('transaction.delete-expense', $value->id) }}"
