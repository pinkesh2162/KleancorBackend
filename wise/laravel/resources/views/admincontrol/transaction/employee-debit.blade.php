        ...
        <div class="row justify-content-center">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <form method="POST" action="{{ route('transaction.employee-debit-store') }}"
                        ...
                        <div class="col-sm-8">
                            <div class="bg-white">
                                <h4>Recent Employee Expenses</h4>
                                <hr />
                                ...
                                <table class="table table-responsive table-striped table-hover table-bordered">
                                    ...
                                    @foreach ($transaction as $key => $value)
                                        <tr>
                                            ...
                                            @if (Auth::user()->type == 2)
                                                <td>
                                                    <a href="{{ route('transaction.edit-debit', $value->id) }}"
                                                        class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>
                                                        Edit</a>
                                                    <a href="{{ route('transaction.delete-debit', $value->id) }}"
