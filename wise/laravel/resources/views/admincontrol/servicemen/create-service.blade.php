            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" novalidate action="{{ route('createservicemen') }}"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" value="{{ old('cost') }}" id="cost" name="cost"
                                        required="required" class="form-control col-md-7 col-xs-12">
                                    @if ($errors->has('cost'))
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" value="{{ old('earning') }}" id="earning" name="earning"
                                        required="required" class="form-control col-md-7 col-xs-12">
