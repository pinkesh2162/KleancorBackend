            ...
            @foreach ($service as $item)
                <tbody>
                    <tr>
                        ...
                        <td>
                            @if (Auth::user()->type == 2)
                                <a href="{{ route('editservicemen', $item->id) }}" class="btn btn-info btn-xs"><i
                                        class="fa fa-pencil"></i>
                                    Edit </a>
                                <button type="button" class="btn btn-danger btn-xs" data-toggle="modal"
                                    data-target="#fridge-{{ $item->id }}"><i class="fa fa-trash-o"></i> Fridge</button>
                                <!--
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="{{ route('fridgeservicemen', $item->id ?? 0) }}" class="btn btn-danger"><i
