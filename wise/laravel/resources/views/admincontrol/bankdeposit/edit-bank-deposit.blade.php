            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('updatetbankdeposit', $bankdeposit->id) }}"
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select name="name" id="" class="form-control col-md-7 col-xs-12"
                                        ...
                                        @foreach ($bank as $item)
                                            <option {{ $bankdeposit->bankid == $item->id ? 'selected' : '' }}
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input value="{{ $bankdeposit->amount }}" type="text" id="amount" name="amount"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="datepicker" autocomplete="off" type="text"
                                        value="{{ $bankdeposit->created_at }}" name="date"
