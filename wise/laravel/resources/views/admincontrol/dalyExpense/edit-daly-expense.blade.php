            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('updateexpense', $dalyExpense->id) }}"
                            class="form-horizontal form-label-left">
                            @csrf
                            <span class="section">Create Dlay Expense</span>

                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="project_name">Project
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select id="project_name" name="project_name" class="form-control col-md-7 col-xs-12"
                                        ...
                                        @foreach ($project as $item)
                                            <option {{ $dalyExpense->projectid == $item->id ? 'selected' : 'No Project' }}
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input value="{{ $dalyExpense->title }}" type="text" id="title" name="title"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select id="payment_method" name="payment_method" required="required"
                                        ...
                                        <option {{ $dalyExpense->payment_method == 1 ? 'selected' : '' }} value="1">Cash
                                        </option>
                                        <option {{ $dalyExpense->payment_method == 2 ? 'selected' : '' }} value="2">
                                            Cheque</option>
                                        <option {{ $dalyExpense->payment_method == 3 ? 'selected' : '' }} value="3">Both
                                        </option>
                                    </select>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select id="only_cheque_bank_name" name="only_cheque_bank_name"
                                            ...
                                            @foreach ($bank as $item)
                                                <option {{ $dalyExpense->bank_id == $item->id ? 'selected' : '' }}
                            ...
                            <div id="both_div_id" class="both_Div" style="display:none;">
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input value="{{ $dalyExpense->cash }}" type="text" id="cash_amount"
                                            name="cash_amount" class="form-control col-md-7 col-xs-12 both_amount">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input value="{{ $dalyExpense->bank_amount }}" type="text"
                                            id="both_cheque_amount" name="both_cheque_amount"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="datepicker" autocomplete="off" type="text"
                                        value="{{ $dalyExpense->date }}" name="date"
