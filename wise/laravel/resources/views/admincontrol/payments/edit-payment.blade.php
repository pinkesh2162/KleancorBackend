            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('updatepayment', $id) }}"
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="select2_single form-control" tabindex="-1" name="salesid">
                                        @foreach ($sales as $item)
                                            <option {{ $paymentinfo->salesid == $item->id ? 'selected' : '' }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="select2_single form-control" tabindex="-1" name="pmethod">
                                        ...
                                        <option {{ $paymentinfo->payment_method == 1 ? 'selected' : '' }} value="1">Cash
                                        </option>
                                        <option {{ $paymentinfo->payment_method == 2 ? 'selected' : '' }} value="2">Bank
                                        </option>
                                        <option {{ $paymentinfo->payment_method == 3 ? 'selected' : '' }} value="3">Bkash
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" value="{{ $paymentinfo->amount }}"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="datepicker" autocomplete="off" type="text"
                                        value="{{ $paymentinfo->created_at }}" name="date"
